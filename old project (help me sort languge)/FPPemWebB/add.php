...
<body style="background-color: #F7C259">
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark shadow" style="background-color: #755C2A">
        <div class="container">
            <a class="navbar-brand text-white active" href="#home" data-bs-target="#brandna">
                <img id="topleft" src="img/Kabupaten Pamekasan.png" class=" d-inline-block align-text-top" alt="xxx" width="30px" height="30px">
    ...
    <section id="home" class="jumbotron text-center " style="padding-top: 6rem;">
        <div>
            <img src="img/Kabupaten Pamekasan.png" style="background-color:#F7C259" alt="Pamekasan Tour Guide" width="225" class="responsive img-fluid" data-aos="fade-down" data-aos-duration="500" />
            <div class="overlay">
    ...
    <section id="TTC" class="TTC">
        <div id="board" class="container text-center">
            <h1 style="color: #6c757d">Tambah Komentar</h1>
            
            <div class="row text-center">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <form action="add.php" method="POST" name="form1">
                    <a class="btn btn-primary" href="Komentar.php" style="text-decoration:none; width:10%; text-align:center;border-radius:1rem;">Back</a>
            <br>
            <br>
                        ...
                        <div class="row">
                                ...
                                <br /><br />
                                <table width="25%" style="color: #6c757d" style="align-items: center;">
                                    <tr>
                                        <td>Nama :</td>
                                    ...
                                    <tr>
                                        <td>Time :</td>
                                        <td><input type="text" name="date" class="form-control" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>Komentar :</td>
                                ...
                                if (isset($_POST['Submit'])) {
                                    ...
                                    $result = mysqli_query($mysqli, "INSERT INTO users(name,email,date,comm) VALUES('$name','$email',CURRENT_TIMESTAMP,'$comm')");
